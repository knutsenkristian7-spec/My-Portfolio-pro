...
export function Projects() {
  const projects: Project[] = [
    ...
    {
      title: "Soccer",
      description: "Architected feature-rich gaming, rewards, and a pack NFT project for a major sports league. Developed a rewards staking feature for our NFT stack.",
      tags: ["Web3", "Blockchain", "Solidity", "React"],
      link: "https://goals.genesisleaguesports.com",
      gradient: "from-purple-500/20 to-pink-500/20",
    },
    {
      title: "Smart contract",
      description: "Created a generic smart contracts viewer feature on the Commonwealth DAO Platform. The feature allowed users to add and view any contract on the Ethereum Networks using just the address and ABI. It also allowed users to call the contract functions.",
      tags: ["Web3", "Blockchain", "Solidity", "React"],
      link: "https://callanycontract.io",
      gradient: "from-purple-500/20 to-pink-500/20",
    },
    {
      title: "Jira",
      description: "Used Jira for bug tracking and feature development tracking. Used Confluence for documentation",
      tags: ["Web3", "Blockchain", "Solidity", "React"],
      link: "https://www.atlassian.com/customers/hy-vee",
      gradient: "from-purple-500/20 to-pink-500/20",
    },
    {
      title: "Unity",
      description: "Built and maintained a dashboard billing page that illustrates the usage of Unity game services with sophisticated graphs and charts.",
      tags: ["Web3", "Blockchain", "Solidity", "React"],
      link: "https://docs.unity.com/en-us/cloud/billing/view-service-data-usage",
      gradient: "from-purple-500/20 to-pink-500/20",
    },
    {
      title: "Back-end API",
